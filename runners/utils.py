...
from dataset.custom import CustomSingleDataset, CustomAlignedDataset, CustomInpaintingDataset, AnimeColorizationDataset
...
def get_dataset(data_config):
    train_dataset = Registers.dataset[data_config.dataset_type](data_config.dataset_config, stage='train')
    val_dataset = Registers.dataset[data_config.dataset_type](data_config.dataset_config, stage='val')
    test_dataset = Registers.dataset[data_config.dataset_type](data_config.dataset_config, stage='test')
